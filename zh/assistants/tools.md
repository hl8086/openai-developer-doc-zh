...
[File Search - 内置 RAG 工具，用于处理和搜索文件](/api/docs/assistants/tools/file-search)

[Code Interpreter - 编写和运行 Python 代码，处理文件和各种数据](/api/docs/assistants/tools/code-interpreter)

[Function Calling - 使用您自己的自定义函数与应用程序交互](/api/docs/assistants/tools/function-calling)

## 后续步骤

*   查看 API 参考以[提交工具输出](/api/docs/api-reference/runs/submitToolOutputs)

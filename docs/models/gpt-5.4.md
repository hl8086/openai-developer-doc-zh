...
GPT-5.4 is our frontier model for complex professional work. Learn more in our [latest model guide](/api/docs/guides/latest-model). Reasoning.effort supports: none (default), low, medium, high and xhigh.

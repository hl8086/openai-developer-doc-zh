...
| --- | --- | --- |
| [`gpt-realtime-2`](/api/docs/models/gpt-realtime-2) | You need the strongest realtime reasoning, tool use, and instruction following. | Tune reasoning effort, preambles, tool policies, exact entity capture, and long-session state. |
| [`gpt-realtime-1.5`](/api/docs/models/gpt-realtime-1.5) | You need a fast, reliable non-reasoning speech-to-speech model. | Follow the core realtime prompt structure and test for latency-sensitive behavior. |
...
*   Learn how to connect with [WebRTC](/api/docs/guides/realtime-webrtc), [WebSocket](/api/docs/guides/realtime-websocket), or [SIP](/api/docs/guides/realtime-sip).
*   Learn the [Realtime conversation lifecycle](/api/docs/guides/realtime-conversations).
*   Review [Realtime costs](/api/docs/guides/realtime-costs).
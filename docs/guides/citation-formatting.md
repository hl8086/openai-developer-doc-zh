...
**Note:** OpenAI-hosted tools such as web search provide automatic inline citations. If you want to use hosted tools instead, see the [tools overview](/api/docs/guides/tools), [web search guide](/api/docs/guides/tools-web-search), and [file search guide](/api/docs/guides/tools-file-search).
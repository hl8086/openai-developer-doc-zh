...
[Realtime and audio overview - Choose the right realtime or audio guide for your use case.](/api/docs/guides/realtime)

[Managing conversations - Work with the Realtime session lifecycle and event model.](/api/docs/guides/realtime-conversations)

[WebRTC connection - Connect browser and mobile audio directly to a Realtime session.](/api/docs/guides/realtime-webrtc)

[Realtime prompting guide - Tune reasoning, preambles, tools, entity capture, and voice behavior.](/api/docs/guides/realtime-models-prompting)
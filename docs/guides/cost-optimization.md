<!-- Source: https://developers.openai.com/api/docs/guides/cost-optimization -->
...
To dive deeper into these, please refer to our guide on [latency optimization](/api/docs/guides/latency-optimization).
...
[Get started with the Batch API →](/api/docs/guides/batch)
...
[Get started with flex processing →](/api/docs/guides/flex-processing)
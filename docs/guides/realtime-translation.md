...
Use [`gpt-realtime-translate`](/api/docs/models/gpt-realtime-translate) when your application should translate what a human says. If you need an assistant that answers questions, calls tools, and manages a conversation, use [`gpt-realtime-2`](/api/docs/models/gpt-realtime-2) with a standard Realtime session instead.
...
[WebRTC connection - Connect browser media to a realtime session.](/api/docs/guides/realtime-webrtc)

[WebSocket connection - Stream raw audio through a server-side media pipeline.](/api/docs/guides/realtime-websocket)

[Realtime transcription - Stream transcript deltas from live audio.](/api/docs/guides/realtime-transcription)
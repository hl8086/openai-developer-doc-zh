...
[Build a prompt in the Playground - Use the Playground to develop and iterate on prompts.](https://platform.openai.com/chat/edit)

[Text generation - Learn how to prompt a model to generate text.](/api/docs/guides/text)

[Engineer better prompts - Learn about OpenAI’s prompt engineering tools and techniques.](/api/docs/guides/prompt-engineering)
...
[Agent definitions - Refine each specialist’s instructions, tools, and output contract.](/api/docs/guides/agents/define-agents)

[Running agents - Understand how handoffs and tools behave inside a run.](/api/docs/guides/agents/running-agents)

[Results and state - See howlastAgentand resumable state affect the next turn.](/api/docs/guides/agents/results)
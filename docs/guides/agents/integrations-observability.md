...
Tool capability semantics still live in [Using tools](/api/docs/guides/tools). This page focuses on the SDK-specific MCP wiring and observability loop.
...
For the platform-wide concept, trust model, and product support story, keep [MCP and Connectors](/api/docs/guides/tools-connectors-mcp) as the canonical reference.
...
*   Feed higher-signal examples into [agent workflow evaluation](/api/docs/guides/agent-evals) once you are ready to score behavior systematically.
...
[Using tools - See how hosted tools, function tools, and agents-as-tools fit beside MCP.](/api/docs/guides/tools#usage-in-the-agents-sdk)

[Guardrails and human review - Add approval or validation boundaries around sensitive capabilities.](/api/docs/guides/agents/guardrails-approvals)

[Agent workflow evaluation - Move from one-off traces into repeatable grading once behavior stabilizes.](/api/docs/guides/agent-evals)
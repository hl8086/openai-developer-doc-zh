...
[Running agents - See how interruptions and resumptions fit into the runtime loop.](/api/docs/guides/agents/running-agents)

[Results and state - Learn which result surfaces paused runs return to your application.](/api/docs/guides/agents/results)

[Using tools - Decide which tool surfaces need validation or approval before side effects happen.](/api/docs/guides/tools#usage-in-the-agents-sdk)
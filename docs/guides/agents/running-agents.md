...
[Results and state - Learn which result surfaces your application should carry into the next turn.](/api/docs/guides/agents/results)

[Orchestration and handoffs - Decide how multiple specialists behave inside the same runtime loop.](/api/docs/guides/agents/orchestration)

[Guardrails and human review - Add validation and approval pauses without breaking turn continuity.](/api/docs/guides/agents/guardrails-approvals)
...
[Agent definitions - Shape one specialist cleanly before you scale the workflow.](/api/docs/guides/agents/define-agents)

[Using tools - Add hosted tools, function tools, and agents-as-tools.](/api/docs/guides/tools#usage-in-the-agents-sdk)

[Running agents - Learn the agent loop, streaming, and continuation strategies.](/api/docs/guides/agents/running-agents)

[Orchestration and handoffs - Decide when specialists should take over the conversation.](/api/docs/guides/agents/orchestration)
...
First you must define an object or data structure to represent the JSON Schema that the model should be constrained to follow. See the [examples](/api/docs/guides/structured-outputs#examples) at the top of this guide for reference.

While Structured Outputs supports much of JSON Schema, some features are unavailable either for performance or technical reasons. See [here](/api/docs/guides/structured-outputs#supported-schemas) for more details.
...
First you must design the JSON Schema that the model should be constrained to follow. See the [examples](/api/docs/guides/structured-outputs#examples) at the top of this guide for reference.
...
You can find an example of how to stream function call arguments without the SDK `stream` helper in the [function calling guide](/api/docs/guides/function-calling#advanced-usage).

...
The [prompt optimizer](https://platform.openai.com/chat/edit?optimize=true) is a chat interface in the dashboard, where you enter a prompt, and we optimize it according to current best practices before returning it to you. Pairing the prompt optimizer with [datasets](/api/docs/guides/evaluation-getting-started) is a powerful way to automatically improve prompts.

## Prepare your data

1.  Set up a [dataset](/api/docs/guides/evaluation-getting-started) containing the prompt you want to optimize and an evaluation dataset.
...
For effective results, add annotations containing a Good/Bad rating _and_ detailed, specific critiques. Create [graders](/api/docs/guides/evaluation-getting-started#adding-graders) that precisely capture the properties that you desire from your prompt.
...
[Fine-tuning - Improve a model’s ability to generate responses tailored to your use case.](/api/docs/guides/fine-tuning)
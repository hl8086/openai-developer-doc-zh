...
[KubernetesUse projected service account tokens in self-managed clusters.](/api/docs/guides/workload-identity-federation/kubernetes)

[AWSUse outbound identity federation or Amazon EKS projected tokens.](/api/docs/guides/workload-identity-federation/aws)

[Microsoft AzureUse managed identity tokens or AKS projected service account tokens.](/api/docs/guides/workload-identity-federation/microsoft-azure)

[Google CloudUse metadata server identity tokens or GKE projected service account tokens.](/api/docs/guides/workload-identity-federation/google-cloud)

[GitHub ActionsUse OIDC tokens in continuous integration workflows.](/api/docs/guides/workload-identity-federation/github-actions)

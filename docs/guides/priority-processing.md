...
*   Per token costs are billed at a premium to standard - see [pricing](/api/docs/pricing) for more information.
...
*   See the [pricing page](/api/docs/pricing) for which models currently support Priority processing.

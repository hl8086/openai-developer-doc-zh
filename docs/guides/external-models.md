<!-- Source: https://developers.openai.com/api/docs/guides/external-models -->
...
*   Your OpenAI organization must be in [usage tier 1](/api/docs/guides/rate-limits/usage-tiers#usage-tiers) or higher.
...
*   An endpoint compatible with [OpenAI’s chat completions endpoint](/api/docs/api-reference/chat/create)
*   An API key
...
[Getting started with evals - Uses Datasets to quickly build evals and interate on prompts.](/api/docs/guides/evaluation-getting-started)

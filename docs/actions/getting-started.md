...
*   _Solution:_ Try to prompt engineer your instructions in the Custom GPT. See examples in our [prompt engineering guide](/api/docs/guides/prompt-engineering)
